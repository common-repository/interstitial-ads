...
class Uji_Interst_Admin_API{
	...
	public function init_fields () {
		...
		$fields['countdown_time'] = array(
								...
								'type' => 'select',
								'default' => '15',
								'options' => array( '5' => __( '5 seconds', 'ujinter' ), '10' => __( '10 seconds', 'ujinter' ), '15' => __( '15 seconds', 'ujinter' ), '20' => __( '20 seconds', 'ujinter' ), '25' => __( '25 seconds', 'ujinter' ), '30' => __( '30 seconds', 'ujinter' ), '60' => __( '1 minute', 'ujinter' ), '120' => __( '2 minutes', 'ujinter' ) ), 
								'section' => 'generate-settings'
								);
		...
		$fields['wait_time'] = array(
								...
								'type' => 'select',
								'default' => '0',
								'options' => array( '0' => __( '0 seconds', 'ujinter' ), '5' => __( '5 seconds', 'ujinter' ), '10' => __( '10 seconds', 'ujinter' ), '15' => __( '15 seconds', 'ujinter' ), '20' => __( '20 seconds', 'ujinter' ), '30' => __( '30 seconds', 'ujinter' ), '60' => __( '1 minute', 'ujinter' ), '120' => __( '2 minutes', 'ujinter' ) ), 
								'section' => 'generate-settings'
								);	
	...
	public function update_mess ( $input ) {
		...
		if($input['cache_in'] == 'yes') $mess = '<br><span style="color: red">'. __( 'Please empty cache!', 'ujinter' ) . '</span>';
		
		$message = sprintf( __( '%s updated %s', 'ujinter' ), $this->opt_name, $mess );

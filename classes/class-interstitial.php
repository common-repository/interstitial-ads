...
// End register_script()
    ...
    public function inter_ads( $id = NULL, $ajax = NULL ) {
        ...
        if ( $this->is_cached() ) {
            ...
            //Timing
            $JSinterAds = array( 'is_cached' => 'true', 'id_post' => $id_post, 'is_front' => is_front_page(), 'ajaxurl' => admin_url( 'admin-ajax.php' ) );
        ...
        if ( $ad_id ) {
            ...
            if ( !$this->is_cached() ) {
                ...
                $JSinterAds = array( 'id_post' => $id_post ) ;
            ...
            $html_ad .= '<!-- Interstitial ads plugin by ©wpmanage.com-->
